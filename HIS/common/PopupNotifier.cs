...
namespace HIS.common
{
    ...
    [DefaultEvent("Click")]
    public partial class PopupNotifier : Component
    {
        ...
        public PopupNotifier(IContainer container)
        {
            container.Add(this);
        ...
        public void Popup()
        {
            if (!disposed)
            {
                if (!frmPopup.Visible)
                {
                    ...
                    if (Scroll)
                    {
                        posStart = RandomNumber(Screen.PrimaryScreen.WorkingArea.Top, Screen.PrimaryScreen.WorkingArea.Bottom);// Screen.PrimaryScreen.WorkingArea.Bottom;
                        posStop = RandomNumber(Screen.PrimaryScreen.WorkingArea.Top, Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height);// Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height;
                    }
                    else
                    {
                        posStart = RandomNumber(Screen.PrimaryScreen.WorkingArea.Top, Screen.PrimaryScreen.WorkingArea.Bottom);// Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height;
                        posStop = RandomNumber(Screen.PrimaryScreen.WorkingArea.Top, Screen.PrimaryScreen.WorkingArea.Bottom);// Screen.PrimaryScreen.WorkingArea.Bottom - frmPopup.Height;
                    }
                    opacityStart = 0;
                    opacityStop = 1;
