...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.TreatInfo dal=new Maticsoft.DAL.TreatInfo();
		public TreatInfo()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.TreatInfo GetModelByCache(int ID)
		{
			
			string CacheKey = "TreatInfoModel-" + ID;
			...
			return (Maticsoft.Model.TreatInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.TreatInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.TreatInfo> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.TreatInfo> modelList = new List<Maticsoft.Model.TreatInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.TreatInfo model;
